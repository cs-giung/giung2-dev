...
def default_argument_parser():
    ...
    parser.add_argument(
        ...
        choices=['CIFAR10_x32', 'CIFAR100_x32', 'TinyImageNet200_x32', 'ImageNet1k_x32'])
    ...
    parser.add_argument(
        '--batch_size', default=80, type=int,
        help='the number of examples for each mini-batch (default: 80)')
    parser.add_argument(
