...
def launch(config, print_fn):
    ...
    val_steps_per_epoch = math.ceil(len(data.val_images) / config.batch_size)
    tst_steps_per_epoch = math.ceil(len(data.tst_images) / config.batch_size)
...
def main():
    ...
    parser.add_argument(
        '--optim_ni', default=48000, type=int,
        help='the number of training iterations (default: 48000)')
    parser.add_argument(
