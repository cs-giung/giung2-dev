...
from giung2.models.layers import ConvBatchEnsemble, DenseBatchEnsemble
...
def launch(config, print_fn):
    ...
    if config.model_style == 'BN-ReLU':
        model = _ResNet(
            conv = partial(ConvBatchEnsemble, use_bias=False, use_ensemble_bias=False,
                           kernel_init=jax.nn.initializers.he_normal(),
                           bias_init=jax.nn.initializers.zeros,
                           r_base=1.0, r_init=jax.nn.initializers.zeros,
                           s_base=1.0, s_init=jax.nn.initializers.zeros,
                           ensemble_size=config.ensemble_size),
            fc   = partial(DenseBatchEnsemble, use_bias=False, use_ensemble_bias=True,
                           kernel_init=jax.nn.initializers.he_normal(),
                           bias_init=jax.nn.initializers.zeros,
                           r_base=1.0, r_init=jax.nn.initializers.zeros,
                           s_base=1.0, s_init=jax.nn.initializers.zeros,
